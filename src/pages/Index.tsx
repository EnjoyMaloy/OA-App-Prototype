        ...
        return (
          <div className="fixed inset-0 z-[60] bg-black/80 flex items-center justify-center sm:p-4" onClick={close}>
            ...
            >
                  ...
                  {kind === "video" && (
                    <div className="flex-1 flex flex-col text-center relative -mx-5 min-h-0">
                      ...
                      >
                        ...
                        <div className="relative flex items-center justify-between gap-2" style={{ color: '#FFF' }}>
                          <div
                          ...
                          {videoMenu && (
                            <>
                              ...
                              />
                              <div
                                className="absolute z-[5] rounded-[28px] overflow-hidden"
                                style={{
                                  right: 0,
                                  bottom: 'calc(100% + 8px)',
                                  minWidth: 180,
              ...
              {/* Bottom button */}
              <div
                className={`px-4 pb-4 pt-0 relative z-[2] ${kind === "video" ? 'transition-opacity duration-300' : ''} ${kind === "video" && videoOrientation === 'portrait' ? 'hidden sm:block' : ''}`}
                style={{
