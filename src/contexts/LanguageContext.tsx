...
const translations = {
  ...
  "bottomNav.profile": { ru: "Профиль", en: "Profile" },
  ...
  "instructions.reset": { ru: "Сбросить", en: "Reset" },
  "instructions.aiSkills": { ru: "ИИ", en: "AI" },
  "instructions.cryptoBasics": { ru: "Крипта", en: "Crypto" },
  "instructions.sort": { ru: "Сортировка:", en: "Sort:" },
  "instructions.newest": { ru: "Сначала новые", en: "Newest first" },
  "instructions.popular": { ru: "Сначала популярные", en: "Most popular first" },
  ...
  "index.videoLandscape": { ru: "Горизонтально", en: "Landscape" },
  "index.videoPortrait": { ru: "Как на телефоне", en: "Phone view" },
  "index.videoHintLandscape": { ru: "Нажми на иконку, чтобы увидеть, как видео смотрится с телефона", en: "Tap the icon to preview how the video looks on a phone" },
  "index.videoHintPortrait": { ru: "Предпросмотр как на вертикальном экране телефона", en: "Preview as on a vertical phone screen" },
